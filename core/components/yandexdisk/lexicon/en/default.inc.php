<?php
$_lang['yandexdisk.source.name'] = 'Yandex Disk';
$_lang['yandexdisk.source.description'] = 'Navigates Yandex Disk files.';
...
$_lang['yandexdisk.error.renameObject'] = 'Error while renaming file "[[+path]]" to "[[+name]]" ([[+message]])';
$_lang['yandexdisk.error.moveObject'] = 'Error while moving file from "[[+path]]" to "[[+newPath]]" ([[+message]])';
$_lang['yandexdisk.error.getContent'] = 'Error while getting content of the file "[[+path]]" ([[+message]])';
$_lang['yandexdisk.error.getThumbnail'] = 'Error while getting thumbnail of the file "[[+path]]" ([[+message]])';